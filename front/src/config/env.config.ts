...
export const env = {
  ...
  API: {
    ...
    ENDPOINT: process.env.NEXT_PUBLIC_API_ENDPOINT || 'http://localhost:1405/lesan',
    PLAYGROUND_URL: process.env.NEXT_PUBLIC_PLAYGROUND_URL || 'http://localhost:1405/playground',
    UPLOAD_URL: process.env.NEXT_PUBLIC_UPLOAD_URL || 'http://localhost:1405/api/upload',
  },
  ...
  PAYMENT: {
    ZARINPAL_MERCHANT_ID: process.env.NEXT_PUBLIC_ZARINPAL_MERCHANT_ID || 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
    ZARINPAL_SANDBOX: process.env.NEXT_PUBLIC_ZARINPAL_SANDBOX === 'true' || true,
    CALLBACK_URL: process.env.NEXT_PUBLIC_PAYMENT_CALLBACK_URL || 'http://localhost:3000/payment/callback',
  },
  ...
  // SEO Configuration
  SEO: {
    SITE_NAME: process.env.NEXT_PUBLIC_SITE_NAME || 'IRAC - Iranian Architecture Center',
    SITE_DESCRIPTION: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'Advanced architectural education and coworking space',
    SITE_KEYWORDS: process.env.NEXT_PUBLIC_SITE_KEYWORDS || 'architecture,education,Iran,coworking,design',
  ...
  MEDIA: {
    ...
    STATIC_URL: process.env.NEXT_PUBLIC_STATIC_URL || 'http://localhost:1405/public',
  ...
  MONITORING: {
    ...
    SENTRY_ENV: process.env.NEXT_PUBLIC_SENTRY_ENV || process.env.NODE_ENV || 'development',
  },
} as const;
