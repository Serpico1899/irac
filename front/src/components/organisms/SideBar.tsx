...
export const AdminSidebar: FC<TProps> = ({
  ...
  return (
    <aside
      className={`sticky top-16 h-[calc(100vh-5rem)] bg-gradient-to-b from-indigo-900 to-purple-900 text-background flex flex-col shadow-xl z-10 transition-all duration-300 ease-in-out ${
        collapsed ? "w-20" : "w-64"
      }`}
    >
            ...
            <li key={item.href}>
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 ${
                  pathname === item.href
                    ? "bg-background/10 text-background shadow-lg"
                    : "hover:bg-background/5 text-gray-200"
                }`}
              >
      ...
      <div className="border-t border-indigo-700/50 p-3 space-y-1">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-background/5 transition-all duration-300"
        >
